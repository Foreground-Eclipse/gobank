...
import (
	...
	models "github.com/Foreground-Eclipse/gobank/storage/model"
	_ "github.com/lib/pq"
)
...
type Storage interface {
	...
	GetAccountByNumber(int64) (*models.Account, error)
}
...
func (s *PostgresStore) GetAccountByNumber(number int64) (*models.Account, error) {
...
func (s *PostgresStore) CreateAccount(acc *models.Account) error {
	...
	(first_name, last_name, number, encrypted_password, balance, created_at) values ($1, $2, $3, $4, $5, $6)`
